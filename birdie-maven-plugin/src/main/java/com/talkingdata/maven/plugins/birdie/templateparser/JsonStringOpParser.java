 ...
 */
public class JsonStringOpParser implements Parser {

    @Override
    public void execute(ObjectNode parameters) {
        STGroup templates = new STGroupFile(Setting.engine + "/jsonstring.stg");
        ST st = templates.getInstanceOf("jsonstring");
