 ...
 */
public class ExtractOperatorParser implements Parser {

    private ObjectMapper objectMapper = new ObjectMapper();

    @Override
    public void execute(ObjectNode parameters) {
        STGroup templates = new STGroupFile(Setting.engine + "/extract.stg");
        ST st = templates.getInstanceOf("extractoperator");
